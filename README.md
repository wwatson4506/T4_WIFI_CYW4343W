...
## This is a new re-write of the WiFi driver for the T4.x and Devboard using an adapted
## version of the Picowi WIFI library by Jeremy P Bentham and our CYW4343W T4.1 modified driver.
## The documentation for the Picowi WIFI library is found at: 
## https://iosoft.blog/2022/12/06/picowi/ and the library at:
